...
<thead><tr><th>کد</th><th>عنوان</th><th>واحد</th><th>مسئول</th><th>وضعیت</th><th>سررسید</th><th>پیگیری</th><th>واگذاری</th></tr></thead>
<tbody>
...
<?php endforeach; ?>
<?php if ($rows === []): ?><tr><td colspan="8" class="m360-empty-state">موردی نیست.</td></tr><?php endif; ?>
</tbody></table></div>
