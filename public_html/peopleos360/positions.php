...
echo '<form class="m360-card m360-form" method="post">'.p360_csrf_field().'<label>کد</label><input name="position_code"><label>عنوان</label><input name="position_title"><label>department_id</label><input name="department_id"><button>ثبت</button></form>';
p360_layout_end();