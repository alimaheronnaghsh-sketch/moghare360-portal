...
function p360_legal_disclaimer_html(): string {
    return '<div class="m360-alert m360-alert-warn">این سامانه موتور تنظیم و اجرای قواعد اداری، حقوق و منابع انسانی است. مقادیر قانونی باید توسط مدیر/مشاور حقوقی براساس آخرین قوانین و بخشنامه‌های رسمی ثبت و تأیید شود. نمونه‌های آزمایشی نیازمند تأیید مدیر/مشاور حقوقی هستند.</div>';
}
