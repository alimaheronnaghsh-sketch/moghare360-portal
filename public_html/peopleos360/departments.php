...
echo '<form class="m360-card m360-form" method="post">'.p360_csrf_field()."<label>کد</label><input name='department_code' required><label>نام</label><input name='department_name' required><label>company_id</label><input name='company_id'><button>ثبت</button></form>";
p360_layout_end();
