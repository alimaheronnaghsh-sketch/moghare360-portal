...
echo '<form class="card" method="post">'.p360_csrf_field().'<label>employee_id</label><input name="employee_id"><label>principal</label><input name="principal_amount"><label>installments</label><input name="installment_count" value="12"><button>ثبت</button></form>';
p360_layout_end();