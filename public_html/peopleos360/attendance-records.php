...
echo '<form class="card" method="post">'.p360_csrf_field().'<label>employee_id</label><input name="employee_id"><label>work_date</label><input name="work_date"><button>محاسبه</button></form>';
p360_layout_end();