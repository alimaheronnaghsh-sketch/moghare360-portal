...
echo '<form class="card" method="post">'.p360_csrf_field()."<label>کد</label><input name='branch_code' required><label>نام</label><input name='branch_name' required><label>company_id</label><input name='company_id'><button>ثبت</button></form>";
p360_layout_end();
