...
echo '<p><a class="btn" href="tool-issue-return.php">تحویل / برگشت ابزار</a></p><div class="table-scroll"><table class="m360-table"><thead><tr><th>کد</th><th>نام</th><th>سریال</th><th>وضعیت</th><th>تحویل‌گیرنده</th></tr></thead><tbody>';
...
echo '<form method="post" action="tool-issue-return.php" class="m360-form" style="margin-top:1rem"><input type="hidden" name="mode" value="create">'.inv360_csrf_field();
