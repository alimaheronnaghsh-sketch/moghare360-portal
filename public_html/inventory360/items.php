...
echo '<div class="table-scroll"><table class="data-table"><thead><tr><th>شناسه</th><th>کد کارگاه</th><th>کد فنی</th><th>نام</th><th>برند</th><th>موجودی</th><th></th></tr></thead><tbody>';
foreach($rows as $r){
