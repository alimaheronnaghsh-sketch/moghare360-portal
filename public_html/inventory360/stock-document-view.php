...
?>
<?php if(!$doc): ?><div class="notice err">سند یافت نشد.</div><?php inv360_layout_end(); exit; endif; ?>
...
<div class="table-scroll"><table class="data-table"><thead><tr><th>کالا</th><th>تعداد</th><th>بها</th></tr></thead><tbody>
