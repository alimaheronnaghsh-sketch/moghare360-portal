...
mirror_render_head('درخواست دسترسی', 'staff');
?>
<section class="m360-hero">
    <h2>درخواست دسترسی</h2>
    <p>درخواست شما پس از بررسی توسط مدیریت پاسخ داده می‌شود.</p>
</section>
...
<section class="m360-card m360-form" style="max-width:560px;margin:0 auto">
    <form method="post" action="user-access-request.php">
        ...
        <select id="requested_role" name="requested_role" required>
            ...
            <option value="company_owner">مدیریت</option>
        </select>
    ...
    <p style="margin-top:1rem"><a href="owner-login.php">ورود مدیریت</a> · <a href="staff-login.php">ورود پرسنل</a></p>
</section>
