...
echo '<a class="p1cc-btn p1cc-btn-primary" href="moghare360-release-download.php">دانلود بسته خروجی (Phase 15)</a>';
echo '<p style="margin-top:.75rem;color:#9aa8b5;font-size:.88rem">Demo Package و Local RC1 — <a href="erp-release-package-dashboard.php">داشبورد بسته خروجی</a></p>';
