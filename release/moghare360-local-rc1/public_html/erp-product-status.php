...
echo '<div class="p1cc-card"><h2 class="p8bl-section-title">فاز ۱۵ — بسته خروجی قابل دانلود</h2>';
echo '<p>وضعیت: <span class="p8bl-badge p8bl-badge-warn">BUILT AFTER TEST</span></p>';
echo '<p style="margin-bottom:.75rem"><a href="erp-release-package-dashboard.php">داشبورد بسته خروجی</a> · <a href="moghare360-release-download.php">دانلود بسته</a></p></div>';
