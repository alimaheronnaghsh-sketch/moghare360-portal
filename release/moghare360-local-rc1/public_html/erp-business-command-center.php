...
echo '<a class="p1cc-btn" href="moghare360-demo-package.php">بسته نمایشی (Phase 12.5)</a> ';
echo '<a class="p1cc-btn" href="erp-security-hardening-dashboard.php">Security Hardening (Phase 13)</a> ';
echo '<a class="p1cc-btn" href="erp-deployment-readiness-dashboard.php">Deployment Plan (Phase 14)</a> ';
echo '<a class="p1cc-btn" href="erp-release-package-dashboard.php">Release Package (Phase 15)</a></p>';
