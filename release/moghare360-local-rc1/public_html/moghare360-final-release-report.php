...
echo '<p style="margin-top:.5rem">PHASE 14 — <a href="erp-deployment-readiness-dashboard.php">Production Deployment Plan</a> · <a href="erp-production-readiness-checklist.php">Production Readiness Checklist</a></p>';
echo '<p style="margin-top:.5rem">PHASE 15 — <a href="erp-release-package-dashboard.php">Downloadable Release Package</a> · <a href="moghare360-release-download.php">Release Download</a></p></div>';
