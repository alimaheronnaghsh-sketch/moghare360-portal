...
echo '<p style="margin-top:.35rem;font-size:.88rem"><a href="erp-production-readiness-checklist.php">چک‌لیست آمادگی Production</a> · <a href="erp-release-package-dashboard.php">بسته خروجی (Phase 15)</a> · <a href="moghare360-release-download.php">دانلود بسته</a></p>';
