...
echo '<p>V1 Final Downloadable / Installable / Mirror Release — Master Server on Laptop · Domain Mirror Only</p></div>';

echo '<div class="p15rel-warning-box"><strong>هشدار:</strong> این دانلود فقط local/demo/mirror است، نه production installer. این فایل‌ها شامل secret/private config/real data نیستند. هاست دامنه بدون دیتابیس و بدون ذخیره داده است.</div>';
