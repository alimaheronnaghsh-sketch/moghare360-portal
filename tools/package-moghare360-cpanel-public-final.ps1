...
<#
.SYNOPSIS
  Build final cPanel public site ZIP (flat root, no secrets, new public model).
#>
...
$StageDir = Join-Path $RepoRoot "release\_cpanel_public_final_stage"
$ZipOut = Join-Path $RepoRoot "release\moghare360-cpanel-public-final.zip"
...
$forbidden = @('config.php', 'erp-config.php', 'mirror-config.php', 'cpanel-public-index.php')
...
Write-Host ""
Write-Host "CPANEL PUBLIC FINAL ZIP CREATED - PASS" -ForegroundColor Green
Write-Host "Path: release/moghare360-cpanel-public-final.zip"
