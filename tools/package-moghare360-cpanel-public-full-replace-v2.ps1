...
<#
.SYNOPSIS
  Build MOGHARE360 full-replace cPanel public site ZIP v2 (flat root, OTP-first, luxury UX).
#>
...
$StageDir = Join-Path $RepoRoot "release\_cpanel_public_full_replace_v2_stage"
$ZipOut = Join-Path $RepoRoot "release\moghare360-cpanel-public-full-replace-v2.zip"
...
Write-Host ""
Write-Host "CPANEL PUBLIC FULL REPLACE V2 ZIP CREATED - PASS" -ForegroundColor Green
Write-Host "Path: release/moghare360-cpanel-public-full-replace-v2.zip"
